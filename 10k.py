...
# 基本參數
url = "https://www.ptt.cc/bbs/MobileComm/search?q=10k"
payload = {
...
for i in range(5):
    ...
    for link in links:
        ...
        if link.a != None:
            ...
            content_2 = content_1.replace("：", "分割").replace("2.使用需求", "分割").replace("3.品牌喜好",
                                                                                             "分割").split("分割")
            # print(content_2)
            while '' in content_2:
                content_2.remove('')
            ...
            # print(title)
            for keyword in ['手錶', '18K', '平板', '15k', '20k', 'Re', '10K長輩機挑選', '跪求', '過度機', '更好的選擇']:
                if keyword in title:
                    break
            else:
